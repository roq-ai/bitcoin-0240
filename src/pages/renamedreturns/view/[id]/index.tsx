...
import { getRenamedreturnById } from 'apiSdk/renamedreturns';
import { RenamedreturnInterface } from 'interfaces/renamedreturn';

function RenamedreturnViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Renamedreturn Details
                  </Text>
                </Box>
                {hasAccess('renamedreturn', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/renamedreturns/edit/${id}`} passHref legacyBehavior>
                    <Button
