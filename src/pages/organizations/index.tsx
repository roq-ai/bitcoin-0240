...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'account.count', 'deposit.count', 'invite.count', 'Renamedreturn.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('deposit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Deposit',
          accessorKey: 'deposit',
          cell: ({ row: { original: record } }: any) => record?._count?.deposit,
        }
      : null,
    hasAccess('invite', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('renamedreturn', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'Renamedreturn',
          header: 'Renamedreturn',
          accessorKey: 'Renamedreturn',
          cell: ({ row: { original: record } }: any) => record?._count?.Renamedreturn,
        }
      : null,
