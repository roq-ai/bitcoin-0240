  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the Power of Digital Wealth with BITCOIN - Visualizing Cryptocurrency Mining and Ensuring Daily Returns on Your Deposits."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the Power of Digital Wealth with BITCOIN - Visualizing Cryptocurrency Mining and Ensuring Daily Returns on Your Deposits.`}
            </Text>
            <Box
